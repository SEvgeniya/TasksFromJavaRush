...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        boolean a;
        if ((Modifier.isPublic(allModifiers)==true&&Modifier.isPublic(specificModifier)==true)||(Modifier.isStatic(allModifiers)==true&&Modifier.isStatic(specificModifier)==true)) {
            a = true;
        }
        else a = false;
        return a;
