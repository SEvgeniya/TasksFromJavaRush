    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                else if (stock1.containsKey("change")) value1 = (double) stock1.get("change");

                if (stock2.containsKey("open")&&stock2.containsKey("last"))
                    value2 = (double) stock2.get("last") - (double) stock2.get("open");
                else if (stock2.containsKey("change")) value2 = (double) stock2.get("change");

                a = name1.compareTo(name2);
                if (a!=0) return a;
                else {
                    b = date2.compareTo(date1);
                    if (b!=0) return b;
